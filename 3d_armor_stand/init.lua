local mod = foundation.new_module("3d_armor_stand", "1.0.0")
...
if foundation.is_module_present("foundation_node_sounds") then
  wood_sounds = foundation.com.node_sounds:build("wood")
...
core.register_node("3d_armor_stand:locked_armor_stand", {
...
core.register_entity("3d_armor_stand:armor_entity", {
  ...
  on_blast = function(self, damage)
    local drops = {}
    local node = core.get_node(self.pos)
